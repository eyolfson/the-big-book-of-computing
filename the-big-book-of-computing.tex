...
\begin{document}
  ...
  \include{chapter/arithmetic}
  \include{chapter/algorithms}
  \include{chapter/recursion}
  \include{chapter/nintendo-entertainment-system}
  \include{chapter/hardware}
  \include{chapter/teensy-3.2}
