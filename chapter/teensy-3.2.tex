...
Current accounting for \textbf{790 bytes} in functions.
...
\hspace{2mm} \texttt{rtc\_set (pins\_teensy.c)}
...
\hexadecimal{00 00 02 EC} call to \texttt{rtc\_set}
...
\paragraph{\texttt{rtc\_set (pins\_teensy.c)}} Sets the real-time clock.
